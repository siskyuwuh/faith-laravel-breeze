                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                                ...
                                <div class="w-full">
                                    <label for="product_color"
                                        class="block mb-2 text-sm font-medium text-gray-900">Warna Produk</label>
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="number" name="product_price" id="product_price"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        value="{{ old('product_price', $product->product_price) }}" placeholder=""
                                        required>
                                </div>
                                ...
                                <div>
                                    <label for="product_stock"
                                        class="block mb-2 text-sm font-medium text-gray-900">Stok Barang</label>
                                    <input type="number" name="product_stock" id="product_stock"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        value="{{ old('product_stock', $product->product_stock) }}" placeholder=""
                                        required>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="product_desc" rows="8"
                                        ...
                                        placeholder="Write a product product_desc here...">{{ old('product_desc', $product->product_desc) }}</textarea>
                                </div>
                            </div>

<x-app-layout>
    <section class="bg-white">
        <div class="py-2">
            ...
            <div class="py-6">
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-10 shadow-md sm:rounded-lg">
                    <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
                        <h2 class="mb-4 text-xl font-bold text-gray-900">Detail product</h2>
                        ...
                        <div class="flex items-center space-x-4">
                            @if ($product->product_status === 1)
                                <button
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">
                                    {{ $product->product_status }}
                                </button>
                            @else
                                <button
                                    class="text-white bg-[#b91c1c] hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">
                                    {{ $product->product_status }}
                                </button>
                            @endif
